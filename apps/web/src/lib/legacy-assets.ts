...
const publicEnvSources: Record<string, string[]> = {
  SUPABASE_URL: ["LB_PUBLIC_SUPABASE_URL", "NEXT_PUBLIC_SUPABASE_URL", "SUPABASE_URL"],
  SUPABASE_ANON_KEY: ["LB_PUBLIC_SUPABASE_ANON_KEY", "NEXT_PUBLIC_SUPABASE_ANON_KEY", "SUPABASE_ANON_KEY"],
